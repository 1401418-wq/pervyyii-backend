...
- Авито-агент — от 59 000 ₽ + 8 900 ₽/мес. Отвечает на сообщения
  ...
  ранжирование объявлений в выдаче Авито.
...
- Доп. услуги (отдельные продукты): голосовой агент на звонки от 129 000 ₽ + 14 900/мес, WhatsApp-агент от 59 000 ₽ + 8 900/мес, Авито-агент от 59 000 ₽ + 8 900/мес, ответы на отзывы от 12 900 ₽/мес (подписка), контент для соцсетей от 24 900 ₽/мес (подписка). По ним — точную цену не называй, говори «обсудим на созвоне».
- Мультиканальность внутри тарифа: Telegram — Премиум, WhatsApp / Авито — Индивидуальный или отдельные услуги.
