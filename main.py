...
- Тарифы агента на сайт: Старт 29 000 ₽ + 4 900 ₽/мес, Про 49 000 ₽ + 7 900 ₽/мес, Премиум 89 000 ₽ + 17 900 ₽/мес, Индивидуальный от 150 000 ₽.
- Виджет ставится на сайт за 5 минут (Tilda, Bitrix24, WordPress, любой конструктор).
- Доп. услуги (отдельные продукты): голосовой агент на звонки от 39 000 ₽ + 6 900/мес, WhatsApp-агент от 35 000 ₽ + 5 900/мес, ответы на отзывы от 9 900 ₽/мес (подписка), контент для соцсетей от 19 000 ₽/мес (подписка). По ним — точную цену не называй, говори «обсудим на созвоне».
